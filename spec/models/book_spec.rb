...
RSpec.describe Book, type: :model do
  ...
  describe 'class methods' do
    ...
    it '.highest_three' do
      ...
      expect(Book.highest_three).to eq([book_4, book_3, book_2])
    end
    ...
    it '.lowest_three' do
      ...
      expect(Book.lowest_three).to eq([book_1, book_2, book_3])
    end
    ...
    it '.highest_rated' do
      ...
      expect(Book.highest_rated).to eq([book_4, book_3, book_2, book_1])
    end
    ...
    it '.lowest_rated' do
      ...
      expect(Book.lowest_rated).to eq([book_1, book_2, book_3, book_4])
    end
  end
end
